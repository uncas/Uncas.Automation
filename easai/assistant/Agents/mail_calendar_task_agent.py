...
class MailCalendarTaskAgent(AgentDefinition):
	...
	def __init__(self):
		import datetime
		from easai.assistant.Functions.manage_calendar import get_todays_calendar_events
		from easai.assistant.Functions.manage_jira import get_my_jira_issues, create_jira_issue
		from easai.assistant.Functions.read_email import read_email
