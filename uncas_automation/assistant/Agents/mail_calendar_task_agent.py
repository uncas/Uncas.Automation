...
class MailCalendarTaskAgent(AgentDefinition):
	...
	def __init__(self):
		import datetime
		from uncas_automation.assistant.Functions.manage_calendar import get_todays_calendar_events
		from uncas_automation.assistant.Functions.manage_jira import get_my_jira_issues, create_jira_issue
		from uncas_automation.assistant.Functions.read_email import read_email
